...
const Footer = () => {
  return (
    <>
    <div className="bg-sky-900 w-full text-white py-10 px-4 lg:px-10  flex justify-between items-center gap-4 mt-10 flex-wrap" >
    ...
    <footer className="bg-sky-900 text-gray-100">
